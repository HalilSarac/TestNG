...
public class C01_SoftAssertion {
    ...
    public void softAssertAramaTesti(){
        ...
        softAssert.assertEquals(actualUrl,expectedUrl,"1. assertion failed");
        ...
        softAssert.assertTrue(actualUrunSayisi>expectedMinUrunSayisi,"2. assertion failed");
        ...
        softAssert.assertTrue(actualUrunIsmiKucukHarf.contains(expectedurunisimIcerik),"3. assertion failed");
