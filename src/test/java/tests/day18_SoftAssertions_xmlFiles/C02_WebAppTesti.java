...
public class C02_WebAppTesti {
    ...
    public void test01(){
        ...
        softAssert.assertEquals(actualUrl,expectedurl,"1.assert");
        ...
        softAssert.assertTrue(zeroWebPage.loginDogrulama.isDisplayed(),"giriş yapıldı testi");
        ...
        softAssert.assertEquals(actualSecilenOption,expectedSecilenOption,"Eurozone testi");
        ...
        softAssert.assertEquals(actualOptionSayisi,expectedOptionSayisi,"dropdown option sayisi testi");

        //16. Dropdown menude "Canada (dollar)" bulunduğunu dogrulayin
        List<WebElement> dropdownOptionElementleriList = select.getOptions();

        List<String> dropDownOptionsListesi = ReusableMethods.stringToList(dropdownOptionElementleriList);

        String expectedOptionIcerik = "Canada (dollar)";

        softAssert.assertTrue(dropDownOptionsListesi.contains(expectedOptionIcerik),"Canada doları testi");
